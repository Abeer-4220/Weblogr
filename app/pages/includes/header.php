    ...
    <header class="p-3 border-bottom">
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="<?= ROOT ?>" class="d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none">
                    <img src="<?= ROOT ?>/assets/images/weblogr-logo.png" alt="logo" class="bi me-2" width="64" height="40">
                </a>

                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="<?= ROOT ?>" class="nav-link px-2 <?= $url[0] == 'home' ? 'link-primary' : '' ?>">Home</a></li>
                    <li><a href="<?= ROOT ?>/blog" class="nav-link px-2 <?= $url[0] == 'blog' ? 'link-primary' : '' ?>">Blogs</a></li>
                    <li><a href="<?= ROOT ?>/contact" class="nav-link px-2 <?= $url[0] == 'contact' ? 'link-primary' : '' ?>">Contact</a></li>
                    <li><a href="<?= ROOT ?>/about" class="nav-link px-2 <?= $url[0] == 'about' ? 'link-primary' : '' ?>">About</a></li>
                    <li>
                ...
                <?php if (logged_in()) : ?>
                    <div class="dropdown text-end">
                        ...
                        <ul class="dropdown-menu text-small mt-2" aria-labelledby="dropdownUser">
                            ...
                            <li><a class="dropdown-item" href="<?= ROOT ?>/admin/profile">Profile</a></li>
                            <li><a class="dropdown-item" href="<?= ROOT ?>/admin">Admin</a></li>
                            <li><a class="dropdown-item" href="<?= ROOT ?>/admin/posts">Posts</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
