    ...
    <footer class="pt-4">
        <div class="row justify-content-center">
            ...
            <ul class="nav justify-content-center border-bottom mb-3 pb-3 gap-3">
                ...
                <li class="nav-item"><a href="<?= ROOT ?>/contact" class="nav-link px-2 text-body-secondary">Contact</a></li>
                <li class="nav-item"><a href="<?= ROOT ?>/about" class="nav-link px-2 text-body-secondary">About</a></li>
                <li class="nav-item"><a href="<?= ROOT ?>/admin" class="nav-link px-2 text-body-secondary">Admin</a></li>
