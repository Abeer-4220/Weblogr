...
<?php include '../app/pages/includes/dark-mode.php'; ?>
  ...
  <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white text-center" href="<?= ROOT ?>/admin">CMS-Admin</a>
          ...
          <div class="offcanvas-body  flex-column p-1 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
              <li class="nav-item my-1">
                <a class="nav-link d-flex align-items-center gap-2 <?= $section == 'dashboard' ? 'active' : '' ?>" aria-current="true" href="<?= ROOT ?>/admin">
              ...
              <li class="nav-item my-1">
                <a class="nav-link d-flex align-items-center gap-2 <?= $section == 'profile' ? 'active' : '' ?>" aria-current="page" href="<?= ROOT ?>/admin/profile">
              ...
              <!-- <li class="nav-item my-1">
                <a class="nav-link d-flex align-items-center gap-2 <?= $section == 'user' ? 'active' : '' ?>" aria-current="page" href="<?= ROOT ?>/admin/user">
            ...
            <ul class="nav flex-column">
              <li class="nav-item my-1">
                <a class="nav-link d-flex align-items-center gap-2" aria-current="page" href="<?= ROOT ?>/home">
            ...
            <ul class="nav flex-column mb-auto">
              <li class="nav-item my-1 mb-5 pb-5">
                <a class="nav-link d-flex align-items-center gap-2" aria-current="page" href="<?= ROOT ?>/logout">
