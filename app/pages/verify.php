<?php
  ...
  // redirect('login');
    ...
    $message = "Welcome to Weblogr <strong>" . user('username') . "</strong><br>" .
           " Your code is: <strong>" . $vars['code'] . "</strong>";
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
		...
		if(!check_verified()){
          ...
          // $vars = array(':email' => user('email'), ':id' => user('id'));
          database_run($query);
...
<body>
    ...
    <div class="my-auto">
        <br>
        <h3 class="h4 mb-3 fw-normal center unselectable font">A verfication code was sent on your email address</h3>
        <div>
        ...
        <main class="form-signin w-100 m-auto shadow rounded-top-3">
            <form method="post">
                ...
                <div class="col-md-6 form-group">
                    <input type="text" name="code" placeholder="Enter your code" class="form-control" minlength="6" maxlength="6" required />
                </div>
                <button class="btn btn-primary ms-5" type="submit">Verify</button>
                </div>
            </form>
    </div>
