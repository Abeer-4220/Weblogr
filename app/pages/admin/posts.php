...
<?php elseif ($action == 'edit') : ?>
	...
	<link rel="stylesheet" type="text/css" href="<?= ROOT ?>/assets/css/rich-text.css">

	<div class="col-md-10 mx-auto">
		<form method="post" enctype="multipart/form-data">

			<h1 class="text-center fs-3 mb-3">Edit post</h1>
			...
			<?php if (!empty($row)) : ?>
				...
				<div class="my-3">
					<span class="fs-5">Featured Image</span><br>
					<label class="d-block">
						<img class="mx-auto d-block image-preview-edit" src="<?= get_image($row['image']) ?>" style="cursor: pointer;width: 250px;height: 250px;object-fit: contain;">
						<input onchange="display_image_edit(this.files[0])" type="file" name="image" class="d-none">
					</label>
					<?php if (!empty($errors['image'])) : ?>
						<div class="text-danger"><?= $errors['image'] ?></div>
				...
				<div class="mb-2 form-floating">
					<input value="<?= old_value('title', $row['title']) ?>" name="title" type="text" class="form-control mb-2" id="floatingInput" placeholder="Username" maxlength="50">
	...
	<script src="<?= ROOT ?>/assets/js/jquery.js"></script>
	<script src="<?= ROOT ?>/assets/js/rich-text.js"></script>
	<script>
		$('#summernote').summernote({
			placeholder: ' Post content',
			tabsize: 2,
...
<?php elseif ($action == 'delete') : ?>
	...
	<div class="col-md-6 mx-auto">
		<form method="post">
			...
			<h1 class="text-center fs-3 mb-3">Delete post</h1>
