...
function check_verified()
{
    ...
    if (is_array($row)) {
        ...
        // Assuming you have 'email_verified' column in the users table
        if (!empty($row->email_verified) && $row->email_verified == $row->email) {
            return true;
        }
    }
...
{
	$string = "mysql:host=localhost;dbname=myblog_db";
